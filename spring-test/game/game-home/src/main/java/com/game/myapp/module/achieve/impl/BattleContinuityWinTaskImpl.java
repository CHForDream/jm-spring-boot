 ...
 *
 */
public class BattleContinuityWinTaskImpl extends CommTaskImpl {

	private static IAchieveTask _Instance = new BattleContinuityWinTaskImpl();
	...
	public void onImpl(int type, long uid, Object... param) {
		...
		lock.lock();
		try {
			int win = Integer.parseInt((String) param[1]);
