 ...
 *
 */
public class ActivityConsumeDailyController extends ActivityBaseHandler {
...
//		ActivityEntity activityEntity = GameGlobals.activityManager.getOpenActivityByType(ActivityManager.ACTIVITY_TYPE_CONSUME_DAILY);
...
//		});
//
//		String record = activityRecordEntity.getConsumDailyRecord();
//		if (record.isEmpty()) {
...
//								ActivityManager.ACTIVITY_TYPE_CONSUME_DAILY, user);
//					}
//				}
//			}
//		}
...
//			String record = recordEntity.getConsumDailyRecord();
//			for (long rewardId : rewardIds) {
//				record += currTime + "," + rewardId + "," + ActivityManager.CAN_REWARD + ";";
//			}
//			recordEntity.setConsumDailyRecord(record);
...
//		try {
//			ActivityRecordEntity recordEntity = GameGlobals.activityManager.getActivityRecordDB(uid);
//			String status = recordEntity.getConsumDailyRecord();
...
//										ActivityManager.ACTIVITY_TYPE_CONSUME_DAILY, rewardsEntity.getRewards(), user);
//							}
//							break loop2;
//						}
//					}
...
//				newStates += s + ";";
//			}
//			recordEntity.setConsumDailyRecord(newStates);
//			Globals.getEntityProxy().updateAsync(recordEntity);
//		} finally {
//			lock.unlock();
//		}
//
//		builder.setType(ActivityManager.ACTIVITY_TYPE_CONSUME_DAILY);
//		builder.setStatus(ActivityManager.REWARD_SUCCESS);
	}

	public String getActivityRewardsState(long uid) {
//		ActivityRecordEntity recordEntity = GameGlobals.activityManager.getActivityRecordDB(uid);
//		return recordEntity.getConsumDailyRecord();
		return null;
	}
...
//			try {
//				ActivityEntity activityEntity = GameGlobals.activityManager.getOpenActivityByType(ActivityManager.ACTIVITY_TYPE_CONSUME_DAILY);
//				if (activityEntity == null || activityEntity.getId() != activityRecordEntity.getConsumDailyActivityId()) {
//					activityRecordEntity.setConsumDailyActivityId(activityEntity == null ? 0 : activityEntity.getId());
//					activityRecordEntity.setConsumDailyRecord("");
