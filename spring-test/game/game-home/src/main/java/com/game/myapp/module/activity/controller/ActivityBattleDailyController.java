 ...
 *
 */
public class ActivityBattleDailyController extends ActivityBaseHandler {
...
//		ActivityEntity activityEntity = GameGlobals.activityManager.getOpenActivityByType(ActivityManager.ACTIVITY_TYPE_BATTLE_DAILY);
...
//		});
//
//		String record = activityRecordEntity.getBattleDailyRecord();
//		if (record.isEmpty()) {
...
//								ActivityManager.ACTIVITY_TYPE_BATTLE_DAILY, user);
//					}
//				}
//			}
//		}
...
//			String record = recordEntity.getBattleDailyRecord();
//			for (long rewardId : rewardIds) {
//				record += currTime + "," + rewardId + "," + ActivityManager.CAN_REWARD + ";";
//			}
//			recordEntity.setBattleDailyRecord(record);
...
//		try {
//			ActivityRecordEntity recordEntity = GameGlobals.activityManager.getActivityRecordDB(uid);
//			String status = recordEntity.getBattleDailyRecord();
...
//										ActivityManager.ACTIVITY_TYPE_BATTLE_DAILY, rewardsEntity.getRewards(), user);
//							}
//							break loop2;
//						}
//					}
...
//				newStates += s + ";";
//			}
//			recordEntity.setBattleDailyRecord(newStates);
//			Globals.getEntityProxy().updateAsync(recordEntity);
//		} finally {
//			lock.unlock();
//		}
//
//		builder.setType(ActivityManager.ACTIVITY_TYPE_BATTLE_DAILY);
//		builder.setStatus(ActivityManager.REWARD_SUCCESS);
	}

	public String getActivityRewardsState(long uid) {
//		ActivityRecordEntity recordEntity = GameGlobals.activityManager.getActivityRecordDB(uid);
//		return recordEntity.getBattleDailyRecord();
		return null;
	}
...
//			try {
//				ActivityEntity activityEntity = GameGlobals.activityManager.getOpenActivityByType(ActivityManager.ACTIVITY_TYPE_BATTLE_DAILY);
//				if (activityEntity == null || activityEntity.getId() != activityRecordEntity.getBattleDailyActivityId()) {
//					activityRecordEntity.setBattleDailyActivityId(activityEntity == null ? 0 : activityEntity.getId());
//					activityRecordEntity.setBattleDailyRecord("");
